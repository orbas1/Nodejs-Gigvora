...
export const AppearanceLayout = sequelize.define(
  'AppearanceLayout',
  {
    ...
    experimentKey: { type: DataTypes.STRING(120), allowNull: true },
    scheduledLaunch: { type: DataTypes.DATE, allowNull: true },
...
AppearanceLayout.prototype.toPublicObject = function toPublicObject() {
  ...
  return {
    ...
    experimentKey: plain.experimentKey ?? null,
    scheduledLaunch: plain.scheduledLaunch ?? null,
