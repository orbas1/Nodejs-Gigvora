...
export const Gig = sequelize.define(
  'Gig',
  {
    ...
    budgetCurrency: { type: DataTypes.STRING(6), allowNull: true },
    budgetMinAmount: { type: DataTypes.DECIMAL(12, 2), allowNull: true },
    budgetMaxAmount: { type: DataTypes.DECIMAL(12, 2), allowNull: true },
    ...
    deliverySpeed: { type: DataTypes.STRING(32), allowNull: true },
...
Gig.prototype.toBuilderObject = function toBuilderObject() {
  ...
  return {
    ...
    trustSignals: plain.trustSignals ?? null,
