...
ProjectWorkspace.prototype.toDashboardSummary = function toDashboardSummary({
  ...
  const summary = {
    ...
    automationCoverage:
      plain.automationCoverage == null ? null : Number(plain.automationCoverage),
    billingStatus: plain.billingStatus ?? null,
    nextMilestone: plain.nextMilestone ?? '',
    nextMilestoneDueAt: toIso(plain.nextMilestoneDueAt),
    lastActivityAt: toIso(plain.lastActivityAt),
    updatedById: plain.updatedById ?? null,
    notes: plain.notes ?? '',
    metrics: safeJsonObject(plain.metricsSnapshot, {}),
    createdAt: toIso(plain.createdAt),
    updatedAt: toIso(plain.updatedAt),
  };
