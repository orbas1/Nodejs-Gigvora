...
export async function updateGuest(req, res) {
  const userId = parsePositiveInteger(req.params.userId, 'userId');
  const eventId = parsePositiveInteger(req.params.eventId, 'eventId');
  const guestId = parsePositiveInteger(req.params.guestId, 'guestId');
...
export async function updateBudgetItem(req, res) {
  const userId = parsePositiveInteger(req.params.userId, 'userId');
  const eventId = parsePositiveInteger(req.params.eventId, 'eventId');
  const budgetItemId = parsePositiveInteger(req.params.budgetItemId, 'budgetItemId');
...
export async function updateAgendaItem(req, res) {
  const userId = parsePositiveInteger(req.params.userId, 'userId');
  const eventId = parsePositiveInteger(req.params.eventId, 'eventId');
  const agendaItemId = parsePositiveInteger(req.params.agendaItemId, 'agendaItemId');
...
export async function updateChecklistItem(req, res) {
  const userId = parsePositiveInteger(req.params.userId, 'userId');
  const eventId = parsePositiveInteger(req.params.eventId, 'eventId');
  const checklistItemId = parsePositiveInteger(req.params.checklistItemId, 'checklistItemId');
