      ...
      packages: [
        {
          ...
          deliverables: ['AI delivery roadmap'],
        },
        {
          tier: 'standard',
          ...
          deliveryDays: '28',
          revisionLimit: '3',
          highlights: ['Delivery squad setup'],
          deliverables: ['Deployment plan', 'Automation backlog'],
        },
        {
          tier: 'premium',
          ...
          deliveryDays: '45',
          revisionLimit: '5',
          highlights: ['Fractional leadership'],
          deliverables: ['Quarterly roadmap', 'Executive workshops'],
        },
      ],
      addOns: [
        {
