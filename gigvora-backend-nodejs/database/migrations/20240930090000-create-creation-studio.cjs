...
const CREATION_STUDIO_VISIBILITIES = ['private', 'workspace', 'public'];
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.addIndex(
        'creation_studio_items',
        ['owner_id'],
        { name: 'creation_studio_items_owner_idx', transaction },
      );

      await queryInterface.addIndex(
        'creation_studio_items',
        ['workspace_id'],
        { name: 'creation_studio_items_workspace_idx', transaction },
      );

      await queryInterface.addIndex(
        'creation_studio_items',
        ['type'],
        { name: 'creation_studio_items_type_idx', transaction },
      );

      await queryInterface.addIndex(
        'creation_studio_items',
        ['status'],
        { name: 'creation_studio_items_status_idx', transaction },
      );

      await queryInterface.addIndex(
        'creation_studio_items',
        ['publish_at'],
        { name: 'creation_studio_items_publish_idx', transaction },
      );

      await queryInterface.addIndex(
        'creation_studio_items',
        ['launch_at'],
        { name: 'creation_studio_items_launch_idx', transaction },
      );
  ...
  async down(queryInterface) {
    ...
    try {
      ...
      await queryInterface.removeIndex('creation_studio_items', 'creation_studio_items_launch_idx', { transaction });
      await queryInterface.removeIndex('creation_studio_items', 'creation_studio_items_publish_idx', { transaction });
