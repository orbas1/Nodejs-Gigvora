        ...
        [
          {
            ...
            metrics_snapshot: JSON.stringify({ activeTracks: 3, approvalsPending: 2 }),
            last_activity_at: new Date('2024-06-24T19:30:00Z'),
      ...
      if (clientAccount) {
        ...
        if (column) {
            ...
            [
              {
                ...
                project_name: 'Activation programme',
                summary: 'Deploy refreshed nurture journey and QA reporting sync.',
                priority: 'high',
                risk_level: 'medium',
                value_currency: 'USD',
                value_amount: 88000,
                potential_monthly_value: 7200,
                contact_name: 'Jordan Ellis',
                contact_email: 'jordan.ellis@example.com',
                owner_name: 'Taylor Reed',
                owner_email: 'taylor.reed@gigvora.test',
                owner_role: 'Engagement Lead',
                health_status: 'healthy',
                start_date: new Date('2024-06-10T00:00:00Z'),
                due_date: new Date('2024-09-30T00:00:00Z'),
                last_interaction_at: new Date('2024-06-22T09:15:00Z'),
                next_interaction_at: new Date('2024-06-29T16:30:00Z'),
                tags: withOrigin({ focus: ['activation', 'crm'], segment: 'enterprise' }),
                metadata: withOrigin({ workspaceId: workspace.id }),
                sort_order: 0,
                created_by_id: ownerId,
                updated_by_id: ownerId,
                notes: 'Pilot complete in region west; prepping insights deck.',
                created_at: new Date(),
                updated_at: new Date(),
              },
            ],
          ...
          if (card) {
              ...
              [
                {
                  ...
                  owner_id: ownerId,
                  workspace_id: workspace.id,
                  title: 'Enable campaign reporting in Looker',
                  completed: true,
                  completed_at: new Date('2024-06-22T13:00:00Z'),
                  sort_order: 0,
                  due_date: new Date('2024-06-20T00:00:00Z'),
                ...
                },
                {
                  ...
                  owner_id: ownerId,
                  workspace_id: workspace.id,
                  title: 'QA lifecycle email sequencing',
                  completed: false,
                  completed_at: null,
                  sort_order: 1,
                  due_date: new Date('2024-06-27T00:00:00Z'),
            ...
            await queryInterface.bulkInsert(
              'pgm_client_kanban_collaborators',
              [
                {
                  card_id: card.id,
                  owner_id: ownerId,
                  workspace_id: workspace.id,
                  name: 'Morgan Blake',
                  email: 'morgan.blake@gigvora.test',
                  role: 'Marketing Ops',
                  avatar_url: null,
                  last_activity_at: new Date('2024-06-22T12:45:00Z'),
                  metadata: withOrigin({ timezone: 'America/New_York' }),
                  created_at: new Date(),
                  updated_at: new Date(),
                },
                {
                  ...
                  role: 'Client Success',
                  avatar_url: null,
                  last_activity_at: new Date('2024-06-23T08:10:00Z'),
                  metadata: withOrigin({ location: 'London' }),
                  created_at: new Date(),
                  updated_at: new Date(),
                },
              ],
