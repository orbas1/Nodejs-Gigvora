...
const baseUsers = [
  {
    ...
    memberships: ['admin', 'company_operator'],
  ...
  },
  {
    ...
    geoLocation: { lat: 38.7223, lng: -9.1393 },
    memberships: ['mentor', 'member'],
    primaryDashboard: 'mentor',
...
const companyProfileSeeds = [
  {
    ...
    location: 'New York, USA',
    geoLocation: { lat: 40.7128, lng: -74.006 },
    tagline: 'Lifecycle intelligence for modern talent marketplaces.',
    logoUrl: 'https://cdn.gigvora.com/demo/lumen-logo.png',
    bannerUrl: 'https://cdn.gigvora.com/demo/lumen-banner.png',
    contactEmail: 'hello@lumen-analytics.example.com',
    contactPhone: '+1-212-555-0101',
    socialLinks: {
      linkedin: 'https://www.linkedin.com/company/lumen-analytics-demo',
      website: 'https://lumen-analytics.example.com',
    },
  },
];
...
const agencyProfileSeeds = [
  {
    ...
    location: 'Toronto, Canada',
    geoLocation: { lat: 43.6532, lng: -79.3832 },
    tagline: 'Multi-disciplinary pods for product velocity.',
    summary: 'Alliance Studio assembles high-trust pods to accelerate product teams across GTM, ops, and analytics.',
    about:
      'From experimentation sprints to large-scale product reorganisations, Alliance Studio brings seasoned operators to every engagement.',
    services: ['product_strategy', 'analytics_instrumentation', 'growth_ops'],
    industries: ['marketplaces', 'saas'],
    clients: ['Lumen Analytics', 'Northstar Ventures'],
    awards: ['2024 GTM Innovation Collective Winner'],
    socialLinks: {
      linkedin: 'https://www.linkedin.com/company/alliancestudio-demo',
      website: 'https://alliancestudio.example.com',
    },
    teamSize: 18,
    foundedYear: 2019,
    primaryContactName: 'Noah Agency',
    primaryContactEmail: 'noah@gigvora.com',
    primaryContactPhone: '+1-416-555-0188',
    brandColor: '#2563eb',
    bannerUrl: 'https://cdn.gigvora.com/demo/alliancestudio-banner.png',
    followerPolicy: 'open',
