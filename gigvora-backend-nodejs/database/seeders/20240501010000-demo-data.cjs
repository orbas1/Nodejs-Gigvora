...
const seededIds = {
  ...
  volunteeringRoles: [1],
  opportunityTaxonomies: [1, 2, 3, 4, 5, 6, 7, 8],
  opportunityTaxonomyAssignments: [1, 2, 3, 4, 5, 6, 7, 8, 9],
  adCampaigns: [1, 2],
  adCreatives: [1, 2, 3],
  adKeywords: [1, 2, 3, 4, 5],
  adKeywordAssignments: [1, 2, 3, 4, 5, 6, 7, 8, 9],
  adPlacements: [1, 2, 3, 4, 5, 6, 7],
  groups: [1],
...
module.exports = {
  async up(queryInterface) {
    ...
    try {
      ...
      await queryInterface.bulkInsert(
        'opportunity_taxonomies',
        [
          {
            id: seededIds.opportunityTaxonomies[0],
            type: 'job',
            slug: 'product-design-leadership',
            label: 'Product Design Leadership',
            description: 'Executive product design roles focused on shipping conversion-led experiences.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['company_dashboard', 'headhunter_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[1],
            type: 'job',
            slug: 'data-platform-engineering',
            label: 'Data Platform Engineering',
            description: 'Reliability and analytics engineering mandates with on-call ownership.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['company_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[2],
            type: 'gig',
            slug: 'conversion-acceleration',
            label: 'Conversion Acceleration Sprints',
            description: 'Rapid CRO and landing page optimisation packages.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['freelancer_dashboard', 'pipeline_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[3],
            type: 'gig',
            slug: 'brand-identity-systems',
            label: 'Brand Identity Systems',
            description: 'Comprehensive identity and collateral refresh engagements.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['freelancer_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[4],
            type: 'freelance',
            slug: 'fractional-creative-director',
            label: 'Fractional Creative Director',
            description: 'Retainer programmes pairing creative leadership with revenue reporting.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['freelancer_dashboard', 'pipeline_dashboard'] },
            createdAt: twoDaysAgo,
          ...
          {
            id: seededIds.opportunityTaxonomies[5],
            type: 'launchpad',
            slug: 'leadership-fellowship',
            label: 'Leadership Fellowship',
            description: 'Cohort-based leadership launchpads with executive mentorship.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['user_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[6],
            type: 'volunteering',
            slug: 'mentorship-open-source',
            label: 'Mentorship & Open Source',
            description: 'Community programmes pairing mentors with OSS contributors.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['user_dashboard', 'global_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.opportunityTaxonomies[7],
            type: 'gig',
            slug: 'onboarding-automation',
            label: 'Onboarding Automation',
            description: 'Lifecycle and onboarding automation packages for SaaS teams.',
            parentId: null,
            isActive: true,
            metadata: { surfaces: ['agency_dashboard', 'freelancer_dashboard'] },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
        ],
      ...
      await queryInterface.bulkInsert(
        'opportunity_taxonomy_assignments',
        [
          {
            id: seededIds.opportunityTaxonomyAssignments[0],
            taxonomyId: seededIds.opportunityTaxonomies[0],
            targetType: 'job',
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[1],
            taxonomyId: seededIds.opportunityTaxonomies[1],
            targetType: 'job',
            targetId: seededIds.jobs[1],
            weight: 3,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[2],
            taxonomyId: seededIds.opportunityTaxonomies[2],
            targetType: 'gig',
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[3],
            taxonomyId: seededIds.opportunityTaxonomies[7],
            targetType: 'gig',
            targetId: seededIds.gigs[1],
            weight: 3,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[4],
            taxonomyId: seededIds.opportunityTaxonomies[3],
            targetType: 'gig',
            targetId: seededIds.gigs[2],
            weight: 2,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[5],
            taxonomyId: seededIds.opportunityTaxonomies[2],
            targetType: 'gig',
            targetId: seededIds.gigs[3],
            weight: 2,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[6],
            taxonomyId: seededIds.opportunityTaxonomies[4],
            targetType: 'freelance',
            targetId: seededIds.freelancerProfiles[0],
            weight: 4,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[7],
            taxonomyId: seededIds.opportunityTaxonomies[5],
            targetType: 'launchpad',
            targetId: seededIds.experienceLaunchpads[0],
            weight: 2,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
          ...
          {
            id: seededIds.opportunityTaxonomyAssignments[8],
            taxonomyId: seededIds.opportunityTaxonomies[6],
            targetType: 'volunteering',
            targetId: seededIds.volunteeringRoles[0],
            weight: 3,
            source: 'seed',
            metadata: { seeded: true },
            createdAt: now,
      ...
      await queryInterface.bulkInsert(
        ...
        [
          {
            id: seededIds.adCampaigns[0],
            name: 'Growth Network Awareness',
            objective: 'brand',
            status: 'active',
            budgetCents: 2500000,
            currencyCode: 'USD',
            ...
            endDate: sixWeeksLater,
            ownerId: seededIds.users[0],
            metadata: { funnel: 'top', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adCampaigns[1],
            ...
            metadata: { funnel: 'mid', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
        ],
      ...
      await queryInterface.bulkInsert(
        ...
        [
          {
            id: seededIds.adCreatives[0],
            campaignId: seededIds.adCampaigns[0],
            name: 'Network Story Mini-Doc',
            type: 'video',
            format: 'mp4',
            status: 'active',
            headline: 'Scale with the Gigvora growth network',
            subheadline: 'Trusted operators ready to deploy on your roadmap.',
            body: 'Activate vetted specialists with dashboards, insights, and compliance handled for you.',
            callToAction: 'See featured teams',
            ctaUrl: 'https://gigvora.com/marketplace',
            mediaUrl: 'https://cdn.gigvora.com/ads/network-mini-doc.mp4',
            durationSeconds: 45,
            primaryColor: '#2B59FF',
            accentColor: '#FFB347',
            metadata: { aspect: '16:9', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adCreatives[1],
            campaignId: seededIds.adCampaigns[0],
            name: 'Conversion Sprint Display',
            type: 'display',
            format: 'banner',
            status: 'active',
            headline: 'Launch CRO sprints in days',
            subheadline: 'Conversion squads, experiment plans, and QA ready out of the box.',
            body: 'Plug Gigvora specialists into your roadmap with real-time analytics and approvals.',
            callToAction: 'Browse sprint kits',
            ctaUrl: 'https://gigvora.com/gigs/conversion-acceleration',
            mediaUrl: 'https://cdn.gigvora.com/ads/conversion-banner.png',
            primaryColor: '#16192C',
            accentColor: '#4ADE80',
            metadata: { size: '1200x628', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adCreatives[2],
            campaignId: seededIds.adCampaigns[1],
            name: 'Pipeline Insights Text',
            type: 'text',
            format: 'native',
            status: 'active',
            headline: 'Unblock recruiting pipelines',
            subheadline: 'Automation playbooks & analyst support for headhunter pods.',
            body: 'Surface pass-on leads, automate check-ins, and accelerate placement velocity.',
            callToAction: 'Review the playbook',
            ctaUrl: 'https://gigvora.com/headhunter/playbooks',
            primaryColor: '#0F172A',
            accentColor: '#38BDF8',
            metadata: { layout: 'insight-card', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
        ],
      ...
      await queryInterface.bulkInsert(
        ...
        [
          {
            id: seededIds.adKeywords[0],
            keyword: 'fractional creative director',
            category: 'freelance',
            intent: 'consideration',
            description: 'Leads seeking creative leadership retainers.',
            metadata: { seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adKeywords[1],
            keyword: 'pipeline automation',
            category: 'operations',
            intent: 'conversion',
            description: 'Automation workflows for recruiting & sales teams.',
            metadata: { seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adKeywords[2],
            keyword: 'talent marketplace',
            category: 'hiring',
            intent: 'awareness',
            description: 'Brand narratives around curated operator networks.',
            metadata: { seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adKeywords[3],
            keyword: 'launchpad fellowship',
            category: 'education',
            intent: 'consideration',
            description: 'Career accelerators and leadership programmes.',
            metadata: { seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adKeywords[4],
            keyword: 'community volunteering',
            category: 'impact',
            intent: 'awareness',
            description: 'Community-led mentorship and volunteering roles.',
            metadata: { seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
      ...
      await queryInterface.bulkInsert(
        'ad_keyword_assignments',
        [
          {
            id: seededIds.adKeywordAssignments[0],
            keywordId: seededIds.adKeywords[0],
            creativeId: seededIds.adCreatives[0],
            taxonomyId: seededIds.opportunityTaxonomies[4],
            weight: 3,
            context: 'headline',
            metadata: { seeded: true },
          ...
          {
            id: seededIds.adKeywordAssignments[1],
            keywordId: seededIds.adKeywords[2],
            creativeId: seededIds.adCreatives[0],
            taxonomyId: seededIds.opportunityTaxonomies[0],
            weight: 2,
            context: 'body',
          ...
          {
            id: seededIds.adKeywordAssignments[2],
            keywordId: seededIds.adKeywords[1],
            creativeId: seededIds.adCreatives[1],
            taxonomyId: seededIds.opportunityTaxonomies[7],
            weight: 3,
            context: 'headline',
            metadata: { seeded: true },
          ...
          {
            id: seededIds.adKeywordAssignments[3],
            keywordId: seededIds.adKeywords[2],
            creativeId: seededIds.adCreatives[1],
            taxonomyId: seededIds.opportunityTaxonomies[2],
            weight: 2,
          ...
          {
            id: seededIds.adKeywordAssignments[4],
            keywordId: seededIds.adKeywords[1],
            creativeId: seededIds.adCreatives[2],
            taxonomyId: seededIds.opportunityTaxonomies[7],
            weight: 2,
            context: 'body',
            metadata: { seeded: true },
          ...
          {
            id: seededIds.adKeywordAssignments[5],
            keywordId: seededIds.adKeywords[3],
            creativeId: seededIds.adCreatives[2],
            taxonomyId: seededIds.opportunityTaxonomies[5],
            weight: 2,
            context: 'headline',
          ...
          {
            id: seededIds.adKeywordAssignments[6],
            keywordId: seededIds.adKeywords[4],
            creativeId: seededIds.adCreatives[2],
            taxonomyId: seededIds.opportunityTaxonomies[6],
            weight: 2,
            context: 'body',
          ...
          {
            id: seededIds.adKeywordAssignments[7],
            keywordId: seededIds.adKeywords[3],
            creativeId: seededIds.adCreatives[0],
            taxonomyId: seededIds.opportunityTaxonomies[5],
            weight: 1,
          ...
          {
            id: seededIds.adKeywordAssignments[8],
            keywordId: seededIds.adKeywords[4],
            creativeId: seededIds.adCreatives[1],
            taxonomyId: seededIds.opportunityTaxonomies[6],
            weight: 1,
        ...
        [
          {
            ...
            weight: 4,
            pacingMode: 'even',
            maxImpressionsPerHour: 120,
            startAt: sevenDaysAgo,
            endAt: threeWeeksLater,
            opportunityType: 'awareness',
            priority: 3,
            metadata: { layout: 'hero-video', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[1],
            creativeId: seededIds.adCreatives[0],
            ...
            maxImpressionsPerHour: 90,
            startAt: sevenDaysAgo,
            endAt: sixWeeksLater,
            opportunityType: 'awareness',
            priority: 2,
            metadata: { placement: 'insight-rail', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[2],
            creativeId: seededIds.adCreatives[1],
            ...
            weight: 3,
            pacingMode: 'even',
            maxImpressionsPerHour: 80,
            startAt: yesterday,
            endAt: sixWeeksLater,
            opportunityType: 'acquisition',
            priority: 4,
            metadata: { placement: 'sidebar-banner', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[3],
            creativeId: seededIds.adCreatives[1],
            ...
            weight: 2,
            pacingMode: 'even',
            maxImpressionsPerHour: 60,
            startAt: inTwoDays,
            endAt: sixWeeksLater,
            opportunityType: 'retention',
            priority: 2,
            metadata: { placement: 'community-card', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[4],
            creativeId: seededIds.adCreatives[2],
            surface: 'headhunter_dashboard',
            position: 'inline',
            status: 'active',
            weight: 4,
            pacingMode: 'even',
            ...
            opportunityType: 'acquisition',
            priority: 4,
            metadata: { placement: 'pipeline-overview', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[5],
            creativeId: seededIds.adCreatives[2],
            surface: 'pipeline_dashboard',
            position: 'inline',
            status: 'active',
            weight: 3,
            pacingMode: 'accelerated',
            maxImpressionsPerHour: 70,
            startAt: yesterday,
            endAt: threeWeeksLater,
            opportunityType: 'acquisition',
            priority: 3,
            metadata: { placement: 'deal-kanban', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
            id: seededIds.adPlacements[6],
            creativeId: seededIds.adCreatives[1],
            ...
            weight: 2,
            pacingMode: 'even',
            maxImpressionsPerHour: 40,
            startAt: nextWeek,
            endAt: sixWeeksLater,
            opportunityType: 'awareness',
            priority: 1,
            metadata: { placement: 'ops-sidebar', seeded: true },
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
        ],
        ...
        [
          {
            ...
            slug: 'gigvora-product-council',
            avatarColor: '#2563eb',
            bannerImageUrl: null,
            visibility: 'private',
            memberPolicy: 'invite',
            createdById: seededIds.users[0],
            updatedById: seededIds.users[0],
            settings: JSON.stringify({
              approvalsRequired: true,
              meetingCadence: 'bi_weekly',
            }),
            metadata: JSON.stringify({
              charter: 'Steer platform roadmap and risk governance.',
        ...
        [
          {
            ...
            status: 'active',
            joinedAt: twoDaysAgo,
            invitedById: seededIds.users[0],
            notes: 'Founder stewardship',
            createdAt: twoDaysAgo,
            updatedAt: now,
          },
          {
  ...
  async down(queryInterface) {
    ...
    try {
      ...
      await queryInterface.bulkDelete(
        'ad_placements',
        { id: { [Op.in]: seededIds.adPlacements } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'ad_keyword_assignments',
        { id: { [Op.in]: seededIds.adKeywordAssignments } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'ad_keywords',
        { id: { [Op.in]: seededIds.adKeywords } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'ad_creatives',
        { id: { [Op.in]: seededIds.adCreatives } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'ad_campaigns',
        { id: { [Op.in]: seededIds.adCampaigns } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'opportunity_taxonomy_assignments',
        { id: { [Op.in]: seededIds.opportunityTaxonomyAssignments } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'opportunity_taxonomies',
        { id: { [Op.in]: seededIds.opportunityTaxonomies } },
        { transaction },
      );
      await queryInterface.bulkDelete(
        'experience_launchpads',
