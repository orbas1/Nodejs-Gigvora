...
export default function MediaStep({ draft, onChange, typeConfig }) {
  ...
  const heroEnabled = features.heroMedia !== false;
    ...
    <div className="space-y-6">
      ...
      {galleryEnabled ? (
        ...
        <div className="rounded-3xl border border-dashed border-slate-200 bg-slate-50 p-6 text-sm text-slate-600">
          Assets are optional for this template. You can add supporting links in the outline step.
        </div>
      )}
