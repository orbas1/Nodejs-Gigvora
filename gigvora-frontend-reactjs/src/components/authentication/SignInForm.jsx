...
export default function SignInForm({ className, supportEmail = 'support@gigvora.com', onAuthenticated }) {
  ...
  return (
    <div className={clsx('rounded-3xl border border-slate-200 bg-white p-8 shadow-soft', className)}>
      {!awaitingTwoFactor ? (
        <form onSubmit={handleCredentialsSubmit} className="space-y-6" noValidate>
          ...
          <SocialAuthButtons
            ...
            helperText="Prefer to use a social account? Choose your network above and we’ll guide you through a secure sign-in."
            secondaryText={rememberMe && rememberedSavedAtLabel ? `Last remembered on ${rememberedSavedAtLabel}.` : undefined}
          />
        ...
        <form onSubmit={handleVerify} className="space-y-6" noValidate>
          ...
          <p className="text-center text-xs text-slate-500">
            ...
            <a href={`mailto:${supportEmail}`} className="font-semibold text-accent hover:text-accentDark">
              {supportEmail}
            </a>{' '}
