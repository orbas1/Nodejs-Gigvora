    ...
    auth: {
      ...
      password: {
        ...
        errors: {
          ...
          birthdate: "Please share your date of birth.",
          weak: "Choose a stronger password to keep your account safe.",
        },
        requirements: {
      ...
      register: {
        ...
        success: "Registration complete. You can now sign in and add any additional roles you need.",
        error: "We could not create your account. Please try again.",
        googleError: "Google sign up failed. Please try again.",
        googleCancelled: "Google sign up was cancelled. Please try again.",
        socialError: "Social sign up is not available right now. Please try another option.",
        submitting: "Creating your profile…",
        cta: "Create profile",
        or: "or",
        socialLabelPrefix: "Sign up with",
        googleUnavailable: "Google sign up unavailable",
        haveAccount: "Already have an account?",
        signInLink: "Sign in",
        continue: "to add more roles or continue where you left off.",
        unlockTitle: "What you unlock",
        identityTitle: "Create once, shine everywhere.",
        identityDescription:
