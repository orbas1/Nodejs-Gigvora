...
export function HomeHeroSection({
  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-24 lg:flex lg:items-center lg:gap-16">
        <div className="mx-auto max-w-2xl space-y-10 text-center lg:mx-0 lg:text-left">
          ...
          <div className="relative mt-10 h-auto min-h-[3.5rem] overflow-hidden rounded-full border border-white/10 bg-white/5 sm:h-14">
        ...
        <div className="mt-16 w-full max-w-lg lg:mt-0 lg:max-w-none">
