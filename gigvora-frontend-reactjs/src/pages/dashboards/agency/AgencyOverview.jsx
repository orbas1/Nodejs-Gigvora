...
export default function AgencyOverview({ displayName = 'Agency team' }) {
  return (
      ...
      <section id="overview" className="space-y-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.35fr_1fr]">
          <div className="space-y-6">
            <section id="delivery" className="rounded-3xl border border-slate-200 bg-white p-8 shadow-soft">
            ...
            <section id="alliances" className="rounded-3xl border border-slate-200 bg-white p-8 shadow-soft">
          ...
          <aside className="space-y-6">
            <section id="finance" className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft">
            ...
            <section id="governance" className="rounded-3xl border border-slate-200 bg-gradient-to-br from-accent/10 via-white to-blue-100 p-6 shadow-soft">
