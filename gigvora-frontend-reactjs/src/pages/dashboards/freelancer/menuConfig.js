...
export const MENU_GROUPS = [
  {
    ...
    items: [
      ...
      },
      {
        id: 'pipeline',
        name: 'Pipeline',
        description: 'Opportunities & interviews',
        icon: ArrowTrendingUpIcon,
        href: '/dashboard/freelancer/pipeline',
      },
      {
        id: 'auto',
        name: 'Auto match',
        description: 'Invite queue',
        icon: BoltIcon,
        href: '/dashboard/freelancer/automatch',
      },
