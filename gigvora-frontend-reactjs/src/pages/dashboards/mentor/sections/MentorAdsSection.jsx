      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <div className="space-y-4 lg:col-span-3">
          {list.length === 0 ? (
            ...
            list.map((campaign) => (
              <article key={campaign.id} className="space-y-4 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {campaign.thumbnail ? (
                    <img src={campaign.thumbnail} alt="Campaign thumbnail" className="h-40 w-full rounded-2xl object-cover" />
                  ) : null}
                  {campaign.creativeUrl ? (
                    <div className="overflow-hidden rounded-2xl border border-slate-200">
                      <iframe
                        title={`${campaign.name} creative`}
                ...
                <p className="text-sm text-slate-600">Audience: {campaign.audience}</p>
