...
import { TopSearchSection, UserIdentityVerificationSection, UserTimelineManagementSection } from './user/sections/index.js';
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'Compliance',
          sectionId: 'affiliate-compliance',
        },
      ],
    },
    {
