...
- **Operations Dashboard**: Authenticated home consolidating queue telemetry, saved-search alerts, portfolio KPIs, and profile metrics with explicit states for unauthenticated visitors, expiring invites, and fairness health messaging.
