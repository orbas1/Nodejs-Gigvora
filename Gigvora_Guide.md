...
- **Backend service (Node.js + MySQL)** – The engine room that handles accounts, security, the live feed, search, reputation, payments, and more for both clients.【F:gigvora-backend-nodejs/README.md†L1-L63】
...
| **Live feed** | Mobile-friendly feed with role checks, cached/offline banners, explorer shortcuts, composer for quick posts, and reaction/comment instrumentation.【F:gigvora-flutter-phoneapp/lib/features/feed/presentation/feed_screen.dart†L13-L199】 | Keeps community storytelling flowing on mobile, even when network conditions fluctuate.【F:gigvora-flutter-phoneapp/lib/features/feed/presentation/feed_screen.dart†L103-L189】 |
