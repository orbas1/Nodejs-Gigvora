...
2. **Functionality.** The frontend summarises per-group activity—active membership, weekly joins, pending invites, trending topics, and engagement scores—while backend snapshot services aggregate membership counts, post cadence, and invite telemetry straight from the production tables.【F:gigvora-frontend-reactjs/src/components/communityManagement/GroupManagementPanel.jsx†L248-L332】【F:gigvora-backend-nodejs/src/services/communityManagementService.js†L15-L213】【F:gigvora-backend-nodejs/src/services/communityManagementService.js†L333-L470】
3. **Logic Usefulness.** Aggregated helpers compute week-over-week joins, expiring invites, scheduled announcements, and engagement ratings so moderators can prioritise nurture actions without pivoting to external spreadsheets or ad hoc SQL.【F:gigvora-backend-nodejs/src/services/communityManagementService.js†L38-L137】【F:gigvora-backend-nodejs/src/services/communityManagementService.js†L333-L438】
