...
- **2.B.5. `ForgotPasswordPage.jsx`**
  ...
  2. **Functionality.** Validates addresses, normalises casing, blocks rapid re-submissions, posts to `/auth/password/forgot`, and offers a guided return to sign-in after success.【F:gigvora-frontend-reactjs/src/pages/ForgotPasswordPage.jsx†L74-L164】
  3. **Logic Usefulness.** Cooldown state, formatted memoised timers, and backend-aware retry parsing align the UI with server throttling policies automatically.【F:gigvora-frontend-reactjs/src/pages/ForgotPasswordPage.jsx†L27-L109】
  ...
  5. **Placeholders.** Security checklist copy stays static for now—consider sourcing from CMS or localisation files to keep messaging fresh.【F:gigvora-frontend-reactjs/src/pages/ForgotPasswordPage.jsx†L166-L185】
